...
async function testVersionConflicts(sessionId: string) {
...
async function testDifferentSources() {
  ...
  const sources = [
    { source: "QR" as const, externalRef: "qr:token-456" },
    { source: "RESERVE" as const, externalRef: "res:reservation-789" },
    { source: "WALK_IN" as const, externalRef: "walkin:uuid-abc123" }
  ];
