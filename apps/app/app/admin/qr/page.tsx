...
export default function AdminQRPage() {
  ...
  // Table options: CODIGO floorplan (F3) when loungeId is CODIGO. Capacity 2 per pilot feedback.
  const CODIGO_TABLES = [
    { id: '301', name: 'Table 301', zone: 'F3', capacity: 2 },
    { id: '302', name: 'Table 302', zone: 'F3', capacity: 2 },
    { id: '303', name: 'Table 303', zone: 'F3', capacity: 2 },
    { id: '304', name: 'Table 304', zone: 'F3', capacity: 2 },
    { id: '305', name: 'Table 305', zone: 'F3', capacity: 2 },
    { id: '306', name: 'Table 306', zone: 'F3', capacity: 2 },
    { id: '307', name: 'Table 307', zone: 'F3', capacity: 2 },
    { id: '308', name: 'Table 308', zone: 'F3', capacity: 2 },
    { id: '309', name: 'Table 309', zone: 'F3', capacity: 2 },
    { id: '310', name: 'Table 310', zone: 'F3', capacity: 2 },
    { id: '311', name: 'Table 311', zone: 'F3', capacity: 2 },
    { id: '312', name: 'Table 312', zone: 'F3', capacity: 2 },
    { id: '313', name: 'Table 313', zone: 'F3', capacity: 2 },
    { id: '401', name: 'Table 401', zone: 'F3', capacity: 2 },
    { id: '402', name: 'Table 402', zone: 'F3', capacity: 2 },
    { id: '403', name: 'Table 403', zone: 'F3', capacity: 2 },
    { id: '501', name: 'Table 501', zone: 'F3', capacity: 2 },
    { id: '502', name: 'Table 502', zone: 'F3', capacity: 2 },
    { id: '601', name: 'Table 601', zone: 'F3', capacity: 2 },
    { id: '602', name: 'Table 602', zone: 'F3', capacity: 2 },
    { id: '603', name: 'Table 603', zone: 'F3', capacity: 2 },
    { id: '701', name: 'Table 701', zone: 'F3', capacity: 2 },
    { id: '702', name: 'Table 702', zone: 'F3', capacity: 2 },
    { id: '703', name: 'Table 703', zone: 'F3', capacity: 2 },
    { id: '704', name: 'Table 704', zone: 'F3', capacity: 2 },
    { id: '705', name: 'Table 705', zone: 'F3', capacity: 2 },
  ]
