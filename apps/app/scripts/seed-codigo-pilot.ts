...
const FLOORPLAN_F3_NODES = [
  ...
  { id: '501', label: '501', type: 'table', x: 15, y: 28, capacity: 2 },
  { id: '502', label: '502', type: 'table', x: 22, y: 28, capacity: 2 },
  { id: '601', label: '601', type: 'table', x: 12, y: 48, capacity: 2 },
  { id: '602', label: '602', type: 'table', x: 12, y: 55, capacity: 2 },
  { id: '603', label: '603', type: 'table', x: 12, y: 62, capacity: 2 },
  { id: '401', label: '401', type: 'table', x: 28, y: 52, capacity: 2 },
  { id: '402', label: '402', type: 'table', x: 28, y: 59, capacity: 2 },
  { id: '403', label: '403', type: 'table', x: 28, y: 66, capacity: 2 },
  { id: '701', label: '701', type: 'table', x: 68, y: 52, capacity: 2 },
  { id: '702', label: '702', type: 'table', x: 65, y: 48, capacity: 2 },
  { id: '703', label: '703', type: 'table', x: 62, y: 44, capacity: 2 },
  { id: '704', label: '704', type: 'table', x: 72, y: 44, capacity: 2 },
  { id: '705', label: '705', type: 'table', x: 75, y: 48, capacity: 2 },
  { id: '301', label: '301', type: 'table', x: 90, y: 12, capacity: 2 },
  { id: '302', label: '302', type: 'table', x: 90, y: 18, capacity: 2 },
  { id: '303', label: '303', type: 'table', x: 90, y: 24, capacity: 2 },
  { id: '304', label: '304', type: 'table', x: 90, y: 30, capacity: 2 },
  { id: '305', label: '305', type: 'table', x: 90, y: 36, capacity: 2 },
  { id: '306', label: '306', type: 'table', x: 90, y: 42, capacity: 2 },
  { id: '307', label: '307', type: 'table', x: 90, y: 48, capacity: 2 },
  { id: '308', label: '308', type: 'table', x: 90, y: 54, capacity: 2 },
  { id: '309', label: '309', type: 'table', x: 90, y: 60, capacity: 2 },
  { id: '310', label: '310', type: 'table', x: 90, y: 66, capacity: 2 },
  { id: '311', label: '311', type: 'table', x: 90, y: 72, capacity: 2 },
  { id: '312', label: '312', type: 'table', x: 90, y: 78, capacity: 2 },
  { id: '313', label: '313', type: 'table', x: 90, y: 84, capacity: 2 },
];
