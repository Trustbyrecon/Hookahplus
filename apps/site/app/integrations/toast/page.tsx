...
export default function ToastIntegrationPage() {
  const faqs = [
    {
      question: "Does Hookah+ replace Toast POS?",
      answer: "No. Hookah+ runs the hookah session timer, flavors, and lounge workflow. Toast stays your card-present POS. Hookah+ syncs key session and order details to Toast."
    },
    {
      question: "What syncs to Toast?",
      answer: "Session total, flavor add-ons, optional notes, timestamps, and receipt-ready line items."
    },
    {
      question: "When will Toast integration be available?",
      answer: "Toast integration is planned for Q2 2026. Join the waitlist to be notified when it launches."
    },
    {
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 border-b border-zinc-800">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-teal-500/10 border border-teal-500/20 rounded-full px-4 py-2 mb-6">
              ...
              <span className="text-teal-400 font-medium">Toast Integration</span>
            </div>
            ...
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              Hookah+ for Toast POS
            </h1>
            
            <p className="text-xl text-zinc-300 mb-8 max-w-2xl mx-auto">
              Run timed hookah sessions, flavor add-ons, and QR checkout, while Toast stays your POS.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold mb-1">Connect Toast</h3>
                  <p className="text-zinc-400">Authorize Hookah+ to access your Toast account (one-time setup)</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-zinc-400">Map Hookah+ session products and add-ons to Toast catalog items</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-zinc-400">When session closes, Hookah+ pushes receipt-ready totals to Toast for checkout</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <Card className="p-8 bg-gradient-to-r from-teal-900/30 to-cyan-900/30 border-teal-500/30">
              <h2 className="text-3xl font-bold mb-4">Join the Toast Integration Waitlist</h2>
              <p className="text-zinc-300 mb-8">
                Be notified when Toast integration launches in Q2 2026.
              </p>
