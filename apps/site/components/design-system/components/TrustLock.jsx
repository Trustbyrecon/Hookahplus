...
const TrustLock = React.forwardRef(({ className, trustScore = 0.87, status = 'active', version = 'TLH-v1', showIcon = true, size = 'md', ...props }, ref) => {
    ...
    return (<div className={cn('flex items-center gap-2 rounded-lg border transition-all duration-200', config.border, config.bg, sizeClasses[size], className)} ref={ref} {...props}>
        {showIcon && (<div className={config.icon}>
        ...
        <div className="flex flex-col">
          ...
          {trustScore > 0 && (<span className="text-xs text-zinc-400">
