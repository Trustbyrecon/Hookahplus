    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            ...
            <div className="space-y-2">
              ...
              <button
                ...
                disabled={loading || !["PREP_IN_PROGRESS", "HEAT_UP", "READY_FOR_DELIVERY", "DELIVERED", "ACTIVE"].includes(session.status)}
                className="w-full bg-red-600 text-white px-3 py-2 rounded text-sm hover:bg-red-700 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Remake
              </button>
              <button
                ...
                disabled={loading || !["PREP_IN_PROGRESS", "HEAT_UP", "READY_FOR_DELIVERY", "OUT_FOR_DELIVERY", "DELIVERED", "ACTIVE"].includes(session.status)}
                className="w-full bg-yellow-600 text-white px-3 py-2 rounded text-sm hover:bg-yellow-700 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Staff Hold
              </button>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          ...
          <div className="space-y-2">
            <p className="text-gray-500 text-sm">Session ID: {session.id}</p>
            <p className="text-gray-500 text-sm">Status: {session.status}</p>
            <p className="text-gray-500 text-sm">Table: {session.tableNumber}</p>
            <p className="text-gray-500 text-sm">Customer: {session.customerName}</p>
          </div>
        </div>
