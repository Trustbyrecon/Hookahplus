...
export default function DemoPage() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-charcoal via-deepMoss to-charcoal text-goldLumen px-6 py-12">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-extrabold tracking-tight">
          🎬 Demo Preview Portal
        </h1>
        <div className="mt-2 h-1 w-32 bg-mystic mx-auto rounded-full animate-pulse" />
        <p className="mt-4 text-lg text-goldLumen">
        ...
        <div className="mt-10 grid gap-6 sm:grid-cols-2">
          <div className="rounded-xl border border-mystic bg-charcoal p-6 shadow hover:shadow-xl transition">
            ...
            <p className="mt-2 text-goldLumen">Preview how customers engage, order, and unlock flavor points.</p>
            <Link
              href="/live"
          ...
          <div className="rounded-xl border border-mystic bg-charcoal p-6 shadow hover:shadow-xl transition">
            ...
            <p className="mt-2 text-goldLumen">Explore dynamic flavor combinations and their loyalty effects.</p>
            <Link
              href="/flavors"
              className="mt-4 inline-block text-ember transition-shadow hover:shadow-[0_0_8px_#E8D7B1]"
            >
          ...
          <div className="rounded-xl border border-mystic bg-charcoal p-6 shadow hover:shadow-xl transition">
            ...
            <p className="mt-2 text-goldLumen">View how Hookah+ tracks, scores, and rewards session behavior.</p>
            <Link
              href="/loyalty"
              className="mt-4 inline-block text-ember transition-shadow hover:shadow-[0_0_8px_#E8D7B1]"
            >
