...
const GlobalNavigation = ({ showTrustLock = true, showStatusIndicators = true, currentPage, flowStatus = 'normal', liveSessions = 0, revenue = '$0', systemHealth = 'excellent' }) => {
    ...
    return (_jsx("nav", { className: "bg-zinc-950 border-b border-zinc-800 shadow-xl sticky top-0 z-50", children: _jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [_jsxs("div", { className: "flex items-center justify-between h-16", children: [_jsxs("div", { className: "flex items-center space-x-3", children: [_jsxs(Link, { href: "/", className: "flex items-center space-x-3 hover:opacity-80 transition-opacity", children: [_jsx("div", { className: "text-teal-400 text-2xl animate-pulse", children: "\uD83C\uDF43" }), _jsx("div", { className: "text-teal-400 font-bold text-xl", children: "HOOKAH+" })] }), activeGroup && (_jsx("div", { className: `${activeGroup.bgColor} text-zinc-300 text-sm font-medium px-3 py-1 rounded-lg border transition-all duration-300`, children: activeGroup.label.toUpperCase() }))] }), _jsxs("div", { className: "flex items-center space-x-6", children: [currentPageInfo && (_jsxs("div", { className: "text-center", children: [_jsxs("div", { className: "flex items-center justify-center space-x-2 text-white", children: [_jsx("span", { className: "text-lg", children: currentPageInfo.icon }), _jsx("span", { className: "font-medium", children: currentPageInfo.label })] }), _jsx("div", { className: "text-sm text-zinc-400", children: currentPageInfo.description })] })), showStatusIndicators && (_jsxs(_Fragment, { children: [_jsx(StatusIndicator, { status: "idle", label: "Current Page", value: "Home" }), _jsx(StatusIndicator, { status: flowStatus, label: "Flow Status", value: getFlowStatusText() }), _jsx(StatusIndicator, { status: "online", label: "Live Sessions", value: liveSessions.toString() }), _jsx(StatusIndicator, { status: "online", label: "Revenue", value: revenue }), _jsx(StatusIndicator, { status: "online", label: "System Health", value: systemHealth.toUpperCase() })] }))] })] }), _jsxs("div", { className: "flex items-center justify-between py-3 border-t border-zinc-800/50", children: [_jsxs("div", { className: "flex items-center space-x-6", children: [_jsx(Link, { href: "/dashboard", className: `px-3 py-2 rounded-lg transition-all duration-200 ${pathname === '/dashboard'
                                        ? 'bg-teal-600 text-white'
                                        : 'text-zinc-300 hover:text-white hover:bg-zinc-800'}`, children: "\uD83D\uDCCA Dashboard" }), _jsx(Link, { href: "/sessions", className: `px-3 py-2 rounded-lg transition-all duration-200 ${pathname.startsWith('/sessions')
                                        ? 'bg-green-600 text-white'
                                        : 'text-zinc-300 hover:text-white hover:bg-zinc-800'}`, children: "\uD83D\uDD25 Sessions" }), _jsx(Link, { href: "/staff", className: `px-3 py-2 rounded-lg transition-all duration-200 ${pathname === '/staff'
                                        ? 'bg-purple-600 text-white'
                                        : 'text-zinc-300 hover:text-white hover:bg-zinc-800'}`, children: "\uD83D\uDC65 Staff Ops" }), _jsx(Link, { href: "/staff-panel", className: `px-3 py-2 rounded-lg transition-all duration-200 ${pathname === '/staff-panel'
                                        ? 'bg-purple-600 text-white'
                                        : 'text-zinc-300 hover:text-white hover:bg-zinc-800'}`, children: "\uD83E\uDDE0 Staff Panel" }), _jsx(Link, { href: "/admin", className: `px-3 py-2 rounded-lg transition-all duration-200 ${pathname.startsWith('/admin')
                                        ? 'bg-blue-600 text-white'
                                        : 'text-zinc-300 hover:text-white hover:bg-zinc-800'}`, children: "\u2699\uFE0F Admin" })] }), _jsxs("div", { className: "flex items-center space-x-3", children: [_jsx(Link, { href: "/support", className: `px-3 py-2 rounded-lg transition-all duration-200 ${pathname.startsWith('/support')
                                        ? 'bg-green-600 text-white'
                                        : 'text-zinc-300 hover:text-white hover:bg-zinc-800'}`, children: "\uD83C\uDFAB Support" }), _jsx(Link, { href: "/docs", className: `px-3 py-2 rounded-lg transition-all duration-200 ${pathname.startsWith('/docs')
                                        ? 'bg-blue-600 text-white'
                                        : 'text-zinc-300 hover:text-white hover:bg-zinc-800'}`, children: "\uD83D\uDCDA Docs" })] })] }), showTrustLock && (_jsx("div", { className: "py-3 border-t border-zinc-800/50", children: _jsx("div", { className: "flex justify-center", children: _jsx(TrustLock, { trustScore: 0.87, status: "active", version: "TLH-v1" }) }) }))] }) }));
};
